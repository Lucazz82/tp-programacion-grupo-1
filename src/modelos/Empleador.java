...
public class Empleador extends Usuario {
	...
	public Empleador(String nombreUsuario, String contrasena,String nombre,TipoPersona tipoPersona,Rubros rubro) {
	...
	public double calcularComision(Ticket ticket) {
		double[][] comisiones = {{0.6, 0.7, 0.8}, {0.8, 0.9, 1.0}};
		...
		return comisiones[this.tipoPersona.getPosicion()][this.rubro.getPosicion()] * sueldoOfrecido;
	}
