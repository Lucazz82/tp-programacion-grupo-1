...
public class TicketBusquedaEmpleado extends Ticket {
	...
	public double enfrentar(Ticket o) {
		...
		puntaje += this.pesos[1] * Remuneracion.enfrentar(this.formulario.getRemuneracion().getPosicion(), o.formulario.getRemuneracion().getPosicion());
		puntaje += this.pesos[2] * this.formulario.getCargaHoraria().enfrentar(o.formulario.getCargaHoraria());
		puntaje += this.pesos[3] * PuestoLaboral.enfrentar(this.formulario.getPuesto().getPosicion(), o.formulario.getPuesto().getPosicion());
		puntaje += this.pesos[4] * RangoEtario.enfrentar(this.formulario.getRangoEtario().getPosicion(), o.formulario.getRangoEtario().getPosicion());
		puntaje += this.pesos[5] * Experiencia.enfrentar(this.formulario.getExperiencia().getPosicion(), o.formulario.getExperiencia().getPosicion());
		puntaje += this.pesos[6] * Estudios.enfrentar(this.formulario.getEstudio().getPosicion(), o.formulario.getEstudio().getPosicion());
